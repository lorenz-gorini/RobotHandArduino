...
from lib.ClearableQueue import ClearableQueue
...
def start_training():
    ...
    while train_action:
        ...
        while confirm_data_input.lower() != 'y':
            ...
            retrieve_data_process = RetrieveDataSocket(stored_data_batches, stop_input, is_training)
            analyze_data_process = TransformSpectraProcess(stored_data_batches, stored_spectrum_batches,
                                                           frequency_batches)
            visualize_data_process = VisualizeSpectraProcess(stored_spectrum_batches, visualized_spectrum_batches,
